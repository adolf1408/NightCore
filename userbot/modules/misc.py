...
async def reedme(e):
    await e.edit(
        ...
        "\n[NightCore's README.md file](https://github.com/adolf1408/NightCore/blob/master/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "My Repo: [NightCore](https://github.com/adolf1408/NightCore)\nOwner: [Leo](https://t.me/leoangkasaaa)\nSupport: [Group](https://t.me/NightCoreUserbot)"
    )
