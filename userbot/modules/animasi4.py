...
async def koc(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`WOYYYYY BOCAH TOLOL`")
        await e.edit("`TAUUU GAK BEDANYAAA KELEDAI SAMA LU?`")
        await e.edit("`GADAAA BEDANYAAA TOLOL`")
        await e.edit("`SAMAAA SAMAAA BOHDOHHH`")
        await e.edit("`XIXIXIXIXIXIXXIXI`")
        await e.edit("`CANDAAA BODOH, EH SERIUS DEH`")
        await e.edit("`GW GABUUTTTT`")
        await e.edit("`KAYA BOCAH NOLEP ASU`")
        await e.edit("`GABUTTTT WOI ANJENG`")
        await e.edit("🙈🙈🙈🙈")
        await e.edit("🙉🙉🙉🙉")
        await e.edit("🙈🙈🙈🙈")
        await e.edit("🙉🙉🙉🙉")
...
async def typewriter(typew):
    ...
    sleep(1)
    await typew.edit("`Banyak Manusia Ga Bersyukur`")
    sleep(1)
    await typew.edit("`Tuhan Sudah Baik Ciptain Otak`")
    sleep(1)
    await typew.edit("`Tapi Ga Digunain`")
    sleep(1)
    await typew.edit("`Contohnya Kalian Semua`")
    sleep(1)
